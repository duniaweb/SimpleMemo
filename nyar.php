...
<form id="form" action="./simpen.php" method="post">
<input type="hidden" name="id" value="<?=date("dmYHis");?>">
<input type="hidden" name="add" value="art"></br>
<form class="form-horizontal">  <fieldset>  
  <legend>Write New</legend>	<div class="form-group">  <label class="control-label" for="inputDefault" name="judul">Title</label>  
  <input class="form-control" id="inputDefault" type="text" name="judul"></div><div class="form-group">  <label class="control-label" for="inputLarge" name="news">Memo</label>
...
<div class="form-group">
  <label class="control-label" for="inputSmall">Comments</label>
