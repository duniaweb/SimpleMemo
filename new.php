...
<form class="form-horizontal">  <fieldset>  
  <legend>Tulis Baru</legend>	<div class="form-group">  <label class="control-label" for="inputDefault" name="judul">Judul</label>  
  <input class="form-control" id="inputDefault" type="text" name="judul"></div><div class="form-group">  <label class="control-label" for="inputLarge" name="news">Tulisan</label>
  <textarea class="form-control" rows="8" id="textArea" type="text" name="news"></textarea></div>
  <div class="form-group">      
  <div class="col-lg-10 col-lg-offset-0">        
  <a class="btn btn-default" href="/index.php">Kembali</a></button> 
  <button type="submit" class="btn btn-success" id="form" value="Simpan">Publikasikan</button>  
...
<div class="form-group">
  <label class="control-label" for="inputSmall">Komentar</label>
  <textarea class="form-control" rows="3" id="textArea" name="komen" cols="10" rows="5"></textarea>
</div>
    <div class="form-group">
      <div class="col-lg-10 col-lg-offset-0">
        <a class="btn btn-default" href="./art.php?id=<?=$id;?>">Kembali</a>
