...
<a class=\"label label-danger\" href=\"./dels.php?del=entry&amp;id=$data[0]\">Delete</a>";}
echo "</div><br></br>";
}}}
echo"<div id=\"form\">";
$komdata=file("./arsip/kom_$id.txt");
echo "";
if(session_is_registered('log')){
echo "<br/><a class=\"label label-danger\" href=\"./dels.php?del=allkom&amp;id=$id\">Clear All Comments</a><br></br>";}
$self="./art.php?id=$id";
if ($hal == ""){$hal = "1";}
...
if ($hal>1) $rew = "<ul class=\"pager\">  <li><a  href=\"$self&amp;hal=".($hal-1)."\">← Prev</a></li></ul>";
...
<a class=\"label label-danger\" href=\"./dels.php?del=koment&amp;nid=$data[1]&amp;id=$data[0]\">Delete</a>";}
echo "</div>";
}?>
<?=$rew.' '.$next;?></div>
<p><a class="btn btn-default" href="./nyar.php?x=komentar&amp;id=<?=$id;?>"> <i class="fa fa-comment-o"></i> Add Comment</a></p><hr>
<?include"cp.php";
include"footer.php";
?>
